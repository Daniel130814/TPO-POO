...
public class Main {
    public static void main(String[] args) {
        ...
        Turno turno = new Turno(1001L, paciente, odontologo, LocalDate.of(2025, 5, 20), LocalTime.of(15, 30));
        // 5. Menú final
        System.out.println("=================================================");
        ...
        System.out.println("   Nombre: " + paciente.getNombreCompleto()+" (DNI: " + paciente.getDni() + ")");
        ...
        System.out.println("   Odontólogo: " + odontologo.getNombreCompleto()+ " (Matrícula: " + odontologo.getMatricula() + ")");
